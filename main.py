...
@bot.on_message(filters.command(["start2"])&(filters.chat(auth_users)))
...
@bot.on_message(filters.command(["stats2"]))
...
@bot.on_message(filters.command(["txt2"])&(filters.chat(auth_users)))
